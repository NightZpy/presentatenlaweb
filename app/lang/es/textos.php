...
return array(
    "our_services" => "Nos encanta la creación de estrategias innovadoras para la web. Todo tipo de empresas nos contratan: hacemos las cosas difíciles fácil, lo imposible lo hacemos realidad; pero nunca tomamos nada a la ligera.",

	"websites" => "Aplicaciones Web a la medida para optimizar su empresa. Convertimos sus necesidades e ideas en una solución Web que dara verdaderos resultados.",
	"web_design" => "Sitios Web especializados en cumplir sus objetivos. Basado en un proceso artístico y de ingeniería con las últimas tendencias de Internet",
	"mobile_applications" => "El mundo ahora es móvil, su empresa en las manos de todos. Convertimos su necesidad e idea en una app para iPhone, iPad y Android.",
